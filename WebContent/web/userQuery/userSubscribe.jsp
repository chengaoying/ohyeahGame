...
<%
	...
	PageModel<UserSubscribeRecord> userSubscribeModel = (PageModel<UserSubscribeRecord>)request.getAttribute("userSubscribeModel");
...
<table style="margin: 0pt auto; padding-top: 10px;" height="101" bgcolor="#cccccc" border="0" cellpadding="3" cellspacing="1" width="98%">
  ...
  <tr bgcolor="#f5f5f5">
	...
	<td align="center" valign="middle" >充值总额(元)</td>
  </tr>
  ...
  <tr style="background: none repeat scroll 0% 0% rgb(255, 255, 255);" onmouseover="this.style.background='#f5f5f5'" onmouseout="this.style.background='#ffffff';" bgcolor="#ffffff">
	...
	<td height="7%" align="center" valign="middle"><%=userSubscribeModel.getTotalPrice() %></td>
...
<table style="margin: 0pt auto; padding-top: 10px;" height="101" bgcolor="#cccccc" border="0" cellpadding="3" cellspacing="1" width="98%">
  <tbody><tr bgcolor="#879999">
    <td colspan="14" height="24"><font color="#FFFFFF">&nbsp;<strong>用户充值记录</strong></font></td>
  </tr>

  <tr bgcolor="#f5f5f5">
    <td height="24" align="center" valign="middle" >日期</td>
    <td height="24" align="center" valign="middle" >游戏名称</td>
	<td align="center" valign="middle" >充值金额(元)</td>
  </tr>


  <%
   for(Iterator it = userSubscribeModel.getList().iterator();it.hasNext();){
  ...
  %>
    ...
    <td height="7%" align="center" valign="middle"><%=DateTimeUtils.formatDate(userSubscribeRecord.getTime(),DateTimeUtils.PATTERN_1) %></td>
        <td height="7%" align="center" valign="middle"><%=userSubscribeRecord.getName() %></td>
    <td height="7%" align="center" valign="middle"><%=userSubscribeRecord.getSubscribeAmount() %></td>
 </tr>
 <%} %>

  <tr>
    <td colspan="14" height="24" bgcolor="#F8FCF6"><div class="page"><span><strong><%=userSubscribeModel.getPageNo() %>/<%=userSubscribeModel.getTotalPages() %></strong></span>
    <a href="servlet/UserRecordServlet?pageNo=<%=userSubscribeModel.getPreviousPageNo() %>&userId=<%=userId %>&subscribeId=subscribe"><img src="image/pre.gif" height="16" width="21"/></a>&nbsp;
    <a href="servlet/UserRecordServlet?pageNo=<%=userSubscribeModel.getNextPageNo() %>&userId=<%=userId %>&subscribeId=subscribe"><img src="image/next.gif" height="16" width="21"/></a></div></td>
  </tr>
</tbody></table>
